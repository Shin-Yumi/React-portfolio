							...
							<div className='bBox'>
								...
								<div className='boardDescWrap moBlock'>
									...
									<p className='boardDesc'>
										...
										harum ex laudantium quas nisi quae voluptatum repudiandae at quisquam maiores
										vero itaque sapiente ut sint fugit, molestiae fugiat? Dolorem.
									</p>
								</div>
							</div>
						</div>
				...
				<article className='contentsHalf boardListCont'>
					<ul className='boardLists'>
							...
							return (
								<li className='boardList' key={idx}>
									<div className='boardBox'>
										<p className='bListTitle'>
											{title.length > 20 ? title.substr(0, 20) + '...' : title}
										</p>
										<p className='bListText'>
						...
						<li className='boardList'>
							<img
								src={process.env.PUBLIC_URL + '/img/dummy-gallery02.jpg'}
								alt='보드이미지입니다'
							/>
						</li>
					</ul>
